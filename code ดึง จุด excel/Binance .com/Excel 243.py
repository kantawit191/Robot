...
] #  อัปเดตล่าสุด   23/10/2024  # ใส่คู่เงินที่ต้องการ เช่น BTCUSDT, ETHUSDT, BNBUSDT
...
# บันทึกข้อมูลทั้งหมดลงในไฟล์ Excel
file_path = 'Crypto_High_Low_Multiple_Symbols_Last_Month.xlsx'
all_data.to_excel(file_path, index=False, sheet_name='Crypto_High_Low')
