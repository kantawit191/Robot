...
api_key = '8PZ7DvqInxGXLrQI8iqWkQL43ZeEjYT0yBxqCEweggODkS6Ia8xWb5gFxCEaFGyf'
api_secret = 'ewjoj9JaXrcY3aULPmcRNOyskb0XSgOLA4isrivCW8FWJuvEKMJx2iEidvZTFdET'
...
def line_notify(message, usdt_used=None, usdt_received=None):
    token = 'IwDxSN4qvtouVIJu5KKIZVXRl3UebTvredCzuXWxlS3'
